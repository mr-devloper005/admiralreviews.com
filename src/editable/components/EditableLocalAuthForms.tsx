...
const inputClass = 'h-12 rounded-md border border-white/12 bg-white px-4 text-base font-bold text-[#101113] outline-none transition placeholder:text-[#101113]/45 focus:border-[#3f7cff] focus:ring-2 focus:ring-[#3f7cff]/25'
const buttonClass = 'inline-flex h-12 items-center justify-center rounded-md bg-[#3f64f4] px-6 text-sm font-black uppercase tracking-[0.12em] text-white shadow-sm transition hover:-translate-y-0.5 disabled:opacity-60'
